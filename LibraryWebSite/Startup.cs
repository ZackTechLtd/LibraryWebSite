...
namespace LibraryWebSite
{
    public class Startup
    {
        ...
        {
            IConfiguration appconfig = Configuration.GetSection("AppConfiguration");
            ...
            services.AddSession(options => {
                ...
                //https://stackoverflow.com/questions/45766941/getting-sessionoptions-cookiename-is-obsolete-in-asp-net-core-2
